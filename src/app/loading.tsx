const loading = () => {
  return (
    <div className="w-full max-w-[640px] h-lvh fixed top-0 left-0 right-0 m-auto bg-primaryColor place-content-center z-50 animate-[fadeout_1s_ease_5s_forwards]">
