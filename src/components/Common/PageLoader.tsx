...
export default function PageLoader() {
  ...
  return (
    ...
    <div className="w-full lg:w-[640px] h-lvh fixed top-0 left-0 right-0 m-auto bg-primaryColor place-content-center z-50 pointer-events-none animate-[fadeout_1s_ease_3s_forwards]">
